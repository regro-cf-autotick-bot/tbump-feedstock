...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tbump-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14823&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tbump-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tbump` can be installed with:

```
conda install tbump
```

It is possible to list all of the versions of `tbump` available on your platform with:
